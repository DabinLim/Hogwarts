...
const Home = (props) => {
    ...
    return(
        <React.Fragment>
            <Container>
                <MainContainer>
                    <Card image={'https://firebasestorage.googleapis.com/v0/b/react-chat-2b875.appspot.com/o/house.png?alt=media&token=a570d28a-f0c6-4124-9ed6-dc1d52c99ddd'} title={'기숙사를 배정 받으세요.'} _onClick ={()=>{openModal()}} button={'마법모자에게 기숙사 배정 받으러 가기'} des={['혹시 신입생 분이시라면 마법모자의 10가지 질문에 대답하시고 어울리는 기숙사에 배정 받으세요.','기숙사를 배정 받은 후에는 기숙사에 소속된 유저들의 프로필과 채팅을 즐길 수 있습니다.']}/>
